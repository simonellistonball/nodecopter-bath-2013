...
var lastPng;
var face_cascade = new cv.CascadeClassifier('node_modules/opencv/data/haarcascade_smile.xml');
var navData;
var flying = false;
      ...
      if( ( ! processingImage ) && lastPng )
      {
        ...
        cv.readImage( lastPng, function(err, im) {
          ...
          face_cascade.detectMultiScale(im, function(err, faces) {
            ...
            if( biggestFace ){
              face = biggestFace;
              console.log('smile :) ', face.x, face.y, face.width, face.height, im.width(), im.height() );
              ...
              im.save('smilefound-' + imageCount++ + '.png');
